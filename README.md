...
## 3. Open Payments via Snowflake Marketplace
- **URL :** Accessible via Snowflake Marketplace (CMS Open Payments)  
...
## 8. NPPES Healthcare Provider Data (Snowflake) 
- **URL :** Accessible via Snowflake Marketplace (CMS NPPES Provider Dataset)  
- **Contenu :** Informations détaillées sur tous les prestataires de santé (NPI, nom, adresse, taxonomies, spécialités, statut actif, champs dérivés).  
- **Usage :** Remplacement du dataset NPPES payant, enrichissement des analyses Open Payments et Medicare Spending, déduplication.  
