...
def get_kpis():
    ...
    SELECT
        ...
        ROUND(SUM(TOTAL_PAYMENT_AMOUNT), 0) as TOTAL_PHARMA_PAYMENTS,
        ROUND(SUM(TOTAL_PRESCRIPTION_COST), 0) as TOTAL_PRESCRIPTION_COSTS,
        ROUND(AVG(PCT_BRAND_CLAIMS), 1) as AVG_BRAND_PCT,
        COUNT(CASE WHEN PCT_BRAND_CLAIMS >= 80 THEN 1 END) as HIGH_BRAND_PRESCRIBERS
